...
import { ContractVersionBase } from "@zora-protocol/coins/src/version/ContractVersionBase.sol";
...
error ThisFeesMismatch();
error CurrencyFeesMismatch();
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function supportsInterface(
        ...
        return interfaceId == type(ICoin).interfaceId || interfaceId == type(ICoinComments).interfaceId
            || interfaceId == type(IERC7572).interfaceId || interfaceId == type(IERC165).interfaceId;
    }
