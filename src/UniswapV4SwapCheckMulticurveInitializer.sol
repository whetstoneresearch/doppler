...
import { UniswapV4SwapCheckMulticurveInitializerHook } from "src/UniswapV4SwapCheckMulticurveInitializerHook.sol";
 ...
 * @param approvedSenders Array of approved addresses that can perform swaps
...
contract UniswapV4SwapCheckMulticurveInitializer is UniswapV4MulticurveInitializer {
    /**
    ...
    function initialize(
        ...
        UniswapV4SwapCheckMulticurveInitializerHook(address(HOOK)).setStartingTime(poolKey, startingTime);
        UniswapV4SwapCheckMulticurveInitializerHook(address(HOOK)).setApproved(poolKey, approvedSenders);
