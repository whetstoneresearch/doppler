 ...
 *
 */
abstract contract FeesManagerV2 is ReentrancyGuard {
    ...
    function collectFees(
        ...
        BalanceDelta fees = _collectFees(poolId, data);
     ...
     */
    function _collectFees(PoolId poolId, bytes calldata data) internal virtual returns (BalanceDelta fees);
