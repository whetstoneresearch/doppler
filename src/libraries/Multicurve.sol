...
library Multicurve {
     ...
     */
    struct LogNormalDistributionParams {
        uint256 index;
        int24 tickLower;
        int24 tickUpper;
        int24 tickSpacing;
     ...
     */
    function calculateLogNormalDistribution(LogNormalDistributionParams memory params)
        internal
        pure
        returns (Position[] memory)
    {
        bool isToken0 = params.isToken0;
        int24 tickLower = params.tickLower;
        int24 tickUpper = params.tickUpper;
        uint16 numPositions = params.numPositions;
        ...
        uint256 amountPerPosition = params.curveSupply / numPositions;
        ...
        for (uint256 i; i < numPositions; i++) {
            ...
            startingTick = alignTick(isToken0, startingTick, params.tickSpacing);
