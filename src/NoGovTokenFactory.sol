...
import { NoGovDERC20 } from "src/NoGovDERC20.sol";
import { ImmutableAirlock } from "src/base/ImmutableAirlock.sol";

/// @custom:security-contact security@whetstone.cc
contract NoGovTokenFactory is ITokenFactory, ImmutableAirlock {
    constructor(
        address airlock_
    ) ImmutableAirlock(airlock_) { }

    /**
     * @notice Creates a new NoGovDERC20 token
