...
contract RebalanceTest is BaseTest {
    ...
    function test_rebalance_CollectsFeeFromAllSlugs() public {
        ...
        int128 amount0ExpectedFee = int128(int256(amount0ToSwap * fee / 1_000_000));
        int128 amount1ExpectedFee = int128(int256(amount1ToSwap * fee / 1_000_000));

        expectedFeesAccrued = toBalanceDelta(amount0ExpectedFee, amount1ExpectedFee);
    ...
    function test_rebalance_FullFlow() public {
        ...
        assertEq(
            upperSlug.tickUpper,
            priceDiscoverySlug.tickLower,
            "first swap: upperSlug.tickUpper != priceDiscoverySlug.tickLower"
        );
        ...
        assertEq(
            upperSlug.tickUpper,
            priceDiscoverySlug.tickLower,
            "second swap: upperSlug.tickUpper != priceDiscoverySlug.tickLower"
        );
        ...
        assertEq(
            upperSlug.tickUpper,
            priceDiscoverySlug.tickLower,
            "third swap: upperSlug.tickUpper != priceDiscoverySlug.tickLower"
        );
        ...
        assertEq(
            upperSlug.tickUpper,
            priceDiscoverySlug.tickLower,
            "fourth swap: upperSlug.tickUpper != priceDiscoverySlug.tickLower"
        );
