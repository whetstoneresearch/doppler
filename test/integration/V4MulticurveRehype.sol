...
// import { InitData, UniswapV4MulticurveRehypeInitializer } from "src/UniswapV4MulticurveRehypeInitializer.sol";
// import {
//     IRehypeHook,
...
//     function test_create_MulticurveInitializerRehypeV4(bytes32 salt) public {
...
//     function test_rehype_MulticurveInitializerRehypeV4_quote_for_asset_only(bytes32 salt) public {
...
//     function test_rehype_MulticurveInitializerRehypeV4_increases_beneficiary_fees(bytes32 salt) public {
//         (bool isToken0,) = _createToken(salt);
...
//     function test_rehype_MulticurveRehypeInitializerHook_collect_fees(bytes32 salt) public {
//         (bool isToken0,) = _createToken(salt);
...
//     function test_rehype_MulticurveRehypeInitializerHook_mixed_swap_types(bytes32 salt) public {
//         (bool isToken0,) = _createToken(salt);
//         IPoolManager.SwapParams memory swapParams = IPoolManager.SwapParams({
//             zeroForOne: !isToken0,
//             amountSpecified: 1 ether,
