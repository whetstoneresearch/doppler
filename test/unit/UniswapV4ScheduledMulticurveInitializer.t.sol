...
import { UniswapV4ScheduledMulticurveInitializer, InitData } from "src/UniswapV4ScheduledMulticurveInitializer.sol";
...
contract UniswapV4ScheduledMulticurveInitializerTest is Deployers {
    ...
    function setUp() public {
        ...
        initializer = new UniswapV4ScheduledMulticurveInitializer(address(airlock), manager, hook);
    ...
    function _prepareInitData() internal returns (InitData memory) {
        ...
        return
            InitData({
                fee: 0, tickSpacing: tickSpacing, curves: curves, beneficiaries: beneficiaries, startingTime: 0
            });
    }
