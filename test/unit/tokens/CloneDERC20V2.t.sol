...
contract CloneDERC20V2Test is Test {
    ...
    function testFuzz_multiSchedule_IndependentVesting(
        ...
        _createToken(schedules, beneficiaries, scheduleIds, amountsArr);
    ...
    function testFuzz_access_OnlyOwnerCanLockPool(address caller) public {
        ...
        vm.prank(caller);
        vm.expectRevert(abi.encodeWithSelector(Ownable.Unauthorized.selector, caller));
    ...
    function test_mintInflation_OwnerReceivesTokens() public {
        ...
        assertGt(ownerBalanceAfter, ownerBalanceBefore, "Owner should receive minted tokens");
    }
    ...
    function test_votingPower_VestedTokensNotCountedBeforeRelease() public {
        ...
        // Beneficiary delegates to self but hasn't released yet
        vm.prank(address(0xa));
    ...
    function test_votingPower_CountsAfterRelease() public {
        ...
        assertEq(token.getVotes(address(0xa)), 1e24, "Released tokens should count for voting");
    }
}
