...
contract UniswapV4RehypeMulticurveInitializerHookTest is Test {
    using PoolIdLibrary for PoolKey;

    UniswapV4MulticurveRehypeInitializerHook public hook;
    ...
    function setUp() public {
        hook = UniswapV4MulticurveRehypeInitializerHook(
            address(
                uint160(
