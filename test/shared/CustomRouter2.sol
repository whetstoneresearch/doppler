...
contract CustomRouter2 {
    ...
    constructor(PoolSwapTest swapRouter_, V4Quoter quoter_) {
    ...
    ) internal pure returns (bool isUsingEth, bool isToken0, address asset, address numeraire) {
    ...
    function computeBuyExactOut(PoolKey calldata key, uint256 amountOut) public returns (uint256) {
        ...
        (uint256 deltaAmount,) = quoter.quoteExactOutputSingle(
