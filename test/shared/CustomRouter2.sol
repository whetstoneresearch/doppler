...
contract CustomRouter2 is Test {
    ...
    function _getHookData(PoolKey calldata key) internal view returns (bool isUsingEth, bool isToken0, address asset, address numeraire) {
    ...
    function mintAndBuy(
        ...
        uint256 mintAmount = amount < 0 ? uint256(-amount) : computeBuyExactOut(key, uint256(amount));
