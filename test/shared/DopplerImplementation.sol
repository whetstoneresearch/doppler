...
contract DopplerImplementation is Doppler {
    ...
    function computeUpperSlugData(PoolKey memory poolKey, uint256 totalTokensSold, int24 currentTick, uint256 assetAvailable)
        public
        view
    ...
    function computePriceDiscoverySlugData(PoolKey memory poolKey, SlugData memory upperSlug, int24 tickUpper, uint256 assetAvailable)
        public
        view
        returns (SlugData memory)
    {
