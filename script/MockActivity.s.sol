...
// This script is meant to be used locally to perform a bunch of transactions and give us some data to work with
contract MockActivityScript is Script {
    function run() public {
    ...
    function _deployToken(
        ...
        WETH(payable(weth)).deposit{ value: amountIn }();
        WETH(payable(weth)).approve(address(0x73855d06DE49d0fe4A9c42636Ba96c62da12FF9C), amountIn);

        ISwapRouter(0x73855d06DE49d0fe4A9c42636Ba96c62da12FF9C).exactInputSingle(swapParams);
    }
}
