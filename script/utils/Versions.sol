...
contract Versions {
    ...
    // --- Lockers ---
    uint8 public constant STREAMABLE_FEES_LOCKER_VERSION = 1;
    ...
    uint8 public constant MULTICURVE_INITIALIZER_VERSION = 1; // DopplerHookInitializer
    // --- Migrators ---
    ...
    // --- Doppler Hooks ---
    uint8 public constant REHYPE_DOPPLER_HOOK_INITIALIZER_VERSION = 3;
