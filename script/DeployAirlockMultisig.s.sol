...
abstract contract DeployAirlockMultisigScript is Script {
    ...
    function run() public {
        ...
        AirlockMultisig multisig = new AirlockMultisig(Airlock(payable(_scriptData.airlock)), DopplerHookInitializer(_scriptData.dopplerHookInitializer), _scriptData.signers);
        vm.stopBroadcast();
    }
}
