...
contract DeployCloneDERC20V2VotesFactoryScript is Script, Config {
    function run() public {
    ...
    function deployToChain(uint256 chainId) internal {
        ...
        vm.startBroadcast();
        bytes32 salt = generateCreate3Salt(msg.sender, type(CloneDERC20V2Factory).name);
        ...
        address factory = ICreateX(createX)
            .deployCreate3(salt, abi.encodePacked(type(CloneDERC20V2Factory).creationCode, abi.encode(airlock)));
