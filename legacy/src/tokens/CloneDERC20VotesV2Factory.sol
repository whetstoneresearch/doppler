...
import { CloneDERC20VotesV2, VestingSchedule } from "src/tokens/CloneDERC20VotesV2.sol";

/**
 * @title CloneDERC20VotesV2Factory
 * @author Whetstone Research
 * @notice Deploys new CloneDERC20VotesV2 tokens using the minimal proxy pattern (EIP-1167)
 * @custom:security-contact security@whetstone.cc
 */
contract CloneDERC20VotesV2Factory is ImmutableAirlock, ITokenFactory {
    ...
    constructor(address airlock_) ImmutableAirlock(airlock_) {
        IMPLEMENTATION = address(new CloneDERC20VotesV2());
        CloneDERC20VotesV2(IMPLEMENTATION)
            .initialize(
                "",
                "",
                0,
    ...
    /**
     * @notice Deploys a new CloneDERC20VotesV2 token
