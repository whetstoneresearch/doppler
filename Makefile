...
deploy-base:
	...
	@bun run ./script/generateDeploymentLogs.ts --chainId 8453 --script DeployBase
	@bun run ./script/generateDeploymentDocs.ts --chainId 8453		
...
deploy-unichain:
	...
	@bun run ./script/generateDeploymentLogs.ts --chainId 130 --script DeployUnichain
	@bun run ./script/generateDeploymentDocs.ts --chainId 130		
...
deploy-v4-base:
	...
	@bun run ./script/generateDeploymentLogs.ts --chainId 8453 --script DeployV4Base
	@bun run ./script/generateDeploymentDocs.ts --chainId 8453		
...
deploy-v4-unichain:
	...
	@bun run ./script/generateDeploymentLogs.ts --chainId 130 --script DeployV4Unichain
	@bun run ./script/generateDeploymentDocs.ts --chainId 130		
...
deploy-v4-ink:
	...
	@bun run ./script/generateDeploymentLogs.ts --chainId 57073 --script DeployV4Ink
	@bun run ./script/generateDeploymentDocs.ts --chainId 57073	
...
deploy-base-sepolia:
	...
	@bun run ./script/generateDeploymentLogs.ts --chainId 84532 --script DeployBaseSepolia
	@bun run ./script/generateDeploymentDocs.ts --chainId 84532	
...
deploy-unichain-sepolia:
	...
	@bun run ./script/generateDeploymentLogs.ts --chainId 1301 --script DeployUnichainSepolia
	@bun run ./script/generateDeploymentDocs.ts --chainId 1301		
